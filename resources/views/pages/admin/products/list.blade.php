                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Thumbnail-->
                                                    <a href="/metronic8/demo1/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                                                        <span class="symbol-label" style="background-image:url(/metronic8/demo1/assets/media//stock/ecommerce/1.png);"></span>
                                                    </a>
                                                    <!--end::Thumbnail-->

                                                    <div class="ms-5">
                                                        <!--begin::Title-->
                                                        <a href="/metronic8/demo1/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">
                                                            {{$product->name.' '}}
                                            ...
                                            <td class="text-end pe-0 dt-type-numeric" data-order="1">
                                                ...
                                                <span class="fw-bold text-warning ms-3">{{$sku->inventory}}</span>
                                            </td>
                                            <td class="text-end pe-0 dt-type-numeric">{{number_format($sku->price, 0, '', ',')}} VNĐ</td>
                                            <td class="text-end pe-0 dt-type-numeric">{{number_format($sku->sale_price, 0, '', ',')}} VNĐ</td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="/metronic8/demo1/apps/ecommerce/catalog/edit-product.html" class="menu-link px-3">
                                                            Sửa
                                                        </a>
                                                    </div>
                                                    <!--end::Menu item-->
