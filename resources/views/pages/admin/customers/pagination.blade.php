        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table">
            ...
            @foreach( $customers as $item)
                <tr class="odd">
                    ...
                    <!--begin::Action=-->
                    <td class="text-end">
{{--                        <div class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions--}}
...
{{--                            <!--end::Svg Icon--></div>--}}
                        <!--begin::Menu-->
                            ...
                            <div class="menu-item px-3">
                                <a href="javascript:void(0)" onclick="openEdit({{$item->id}})" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_customer"  class="menu-link px-3">Sửa</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="javascript:void(0)" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Xóa</a>
                            </div>
                            <!--end::Menu item-->
                        <!--end::Menu-->
                    </td>
