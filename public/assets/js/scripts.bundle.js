...
var KTDrawerHandlersInitialized = !1, KTDrawer = function (e, t) {
    ...
    if (null != e) {
        var i = {
            ...
            var e = f(), t = p(), i = m("direction"), r = m("top"),
                o = m("bottom"), a = m("start"), s = m("end");
    ...
    if (null != e) {
        var i = {
            ...
            if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.show", e)) {
                ...
                c(e) || p(e);
                var t = g(e), i = L(e, "width"), r = L(e, "height"),
...
var KTScrollHandlersInitialized = !1, KTScroll = function (e, t) {
    ...
    if (e) {
        var i = {saveState: !0}, r = function () {
            ...
            var e, t = KTUtil.getViewPort().height, i = f("dependencies"),
                r = f("wrappers"), o = f("offset");
...
var KTStickyHandlersInitialized = !1, KTSticky = function (e, t) {
    ...
    if (null != e) {
        var i = {
            ...
            var t = u("top");
            t = t ? parseInt(t) : 0;
            var i = u("left"), r = u("right"), o = u("width"), a = u("zindex"),
                l = u("dependencies"), d = u("class"), c = s(),
                m = u("height-offset");
...
var KTUtil = function () {
    ...
    return {
        init: function (e) {
            ...
            const i = e.offsetTop, r = i + e.clientHeight + n, o = t.scrollTop,
                a = o + t.clientHeight;
            return i >= o && r <= a
            ...
            let t = e.getBoundingClientRect().left,
                ...
                o = e.clientWidth, a = e.clientHeight;
